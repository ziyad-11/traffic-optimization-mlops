...
- **PCA (Principal Component Analysis)**: Used for dimensionality reduction to remove redundant features and improve model efficiency.  
- **Random Forest**: An ensemble learning algorithm that combines multiple decision trees to improve prediction accuracy.  
- **SVM (Support Vector Machine)**: Used to find optimal decision boundaries in the data to predict traffic density.  
...
flowchart TD
    ...
    D --> E[Model Training - Random Forest and SVM]
